...
- **Custom Instructions** — contexto permanente del proyecto (ver [sección 4](04-custom-instructions-skills-agents.md))
- **Skills** — conocimiento especializado por dominio (ver [sección 4](04-custom-instructions-skills-agents.md))
- **Plugins** — bundles instalables del marketplace (ver [sección 3](03-marketplace-plugins.md))
- **MCP** — conexión a servicios externos en tiempo real (ver [sección 5](05-mcp.md))
