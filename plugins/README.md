...
> 💡 Consulta el [README del plugin de referencia](dynamics365-powerplatform/README.md) para entender la estructura y las convenciones de authoring de agents y skills.
